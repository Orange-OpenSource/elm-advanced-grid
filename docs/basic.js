...
var $Skinney$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {ay: charsProcessed, aH: hash, ar: seed, aM: shift};
	});
...
var $Skinney$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.aH)) ? (data.ar ^ A2(
		...
		A2(
			...
			15,
			A2($Skinney$murmur3$Murmur3$multiplyBy, $Skinney$murmur3$Murmur3$c1, data.aH)))) : data.ar;
	var h0 = acc ^ data.ay;
...
var $Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_v0 === 24) {
			...
			return {ay: data.ay + 1, aH: res, ar: data.ar, aM: data.aM + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$hidden = {z: 0, aL: 0, bo: 'hidden', bp: 0};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$floatColumnConfig = function (properties) {
	...
	return {
		...
		aR: A2($elm$core$Basics$composeR, nestedDataGetter, $elm$core$String$fromFloat)
	};
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$intColumnConfig = function (properties) {
	...
	return {
		...
		aR: A2($elm$core$Basics$composeR, nestedDataGetter, $elm$core$String$fromInt)
	};
};
...
var $rtfeldman$elm_css$Css$visible = {aL: 0, L: 0, bo: 'visible', bp: 0};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$init = F2(
	function (config, data) {
		...
		return _Utils_update(
			initialModel,
			{
				aA: $Orange_OpenSource$elm_advanced_grid$Grid$columnsX(initialModel)
			});
	});
					...
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$displayFlex,
								$rtfeldman$elm_css$Css$height(
								$rtfeldman$elm_css$Css$px(model.h.ej)),
								$rtfeldman$elm_css$Css$width(
...
var $Orange_OpenSource$elm_advanced_grid$Grid$infiniteListConfig = function (model) {
	return A2(
		...
		$FabienHenon$elm_infinite_list_view$InfiniteList$config(
			{
				dP: model.h.dP,
				ed: $FabienHenon$elm_infinite_list_view$InfiniteList$withConstantHeight(model.h.ej),
				ef: $Orange_OpenSource$elm_advanced_grid$Grid$viewRow(model)
			}));
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$withColumnsX = function (model) {
	return _Utils_update(
		model,
		{
			aA: $Orange_OpenSource$elm_advanced_grid$Grid$columnsX(model)
		});
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$resizeColumn = F2(
	function (model, x) {
		...
		if (!_v0.$) {
			...
			var newColumns = (_Utils_cmp(newWidth, $Orange_OpenSource$elm_advanced_grid$Grid$minColumnWidth) > 0) ? A3($Orange_OpenSource$elm_advanced_grid$Grid$updateColumnWidthProperty, model, columnConfig, newWidth) : model.h.dM;
...
var $Orange_OpenSource$elm_advanced_grid$Grid$filteredData = function (model) {
	return A3(
		$elm$core$List$foldl,
		F2(
...
var $Orange_OpenSource$elm_advanced_grid$Grid$updateVisibleItems = function (model) {
	var filteredContent = $Orange_OpenSource$elm_advanced_grid$Grid$filteredData(model);
	var visibleItems = A2(
		$elm$core$List$indexedMap,
		F2(
			function (index, value) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 14:
				...
				var draggedColumn = {aY: columnConfig, aC: mousePosition.v, bH: '', v: mousePosition.v};
				return A2(
			...
			case 11:
				var columnConfig = msg.a;
				return model.a$ ? model : A4($Orange_OpenSource$elm_advanced_grid$Grid$sort, model, columnConfig, model.ao, $Orange_OpenSource$elm_advanced_grid$Grid$toggleOrder);
			case 13:
				var item = msg.a;
				return _Utils_update(
					model,
			...
			case 21:
				...
				if (!_v3.$) {
					...
					if (_Utils_eq(columnConfig.b.R, draggedColumn.bH)) {
						...
						var newColumns = A3($Orange_OpenSource$elm_advanced_grid$Grid$moveColumn, columnConfig, draggedColumnConfig, model.h.dM);
						return A2(
							$Orange_OpenSource$elm_advanced_grid$Grid$withDraggedColumn,
							$elm$core$Maybe$Just(
								_Utils_update(
			...
			case 22:
				...
				return _Utils_update(
					model,
					{bG: newStatus, q: updatedVisibleItems});
			case 23:
				var columnConfig = msg.a;
				...
				var newColumns = A3(
					...
					A3($Orange_OpenSource$elm_advanced_grid$Grid$updateColumnProperties, toggleVisibility, model, columnConfig.b.R));
				var updatedModel = A2($Orange_OpenSource$elm_advanced_grid$Grid$withColumns, newColumns, model);
				return _Utils_update(
					updatedModel,
					{
						aA: $Orange_OpenSource$elm_advanced_grid$Grid$columnsX(updatedModel)
					});
			case 24:
				var item = msg.a;
				var newItems = A3(
			...
			default:
				...
				var updatedData = A2($elm$core$List$map, updateContent, model.aZ);
				return $Orange_OpenSource$elm_advanced_grid$Grid$updateVisibleItems(
					A2($Orange_OpenSource$elm_advanced_grid$Grid$withContent, updatedData, model));
		}
	});
		...
		var updateComputations = F2(
			function (item, calculatedTuple) {
				...
				return (_Utils_cmp(newCurrentHeight, scrollTop - offset) < 1) ? _Utils_update(
					calculatedTuple,
					{aB: newCurrentHeight, bA: elementsCountToSkip + 1, a3: idx + 1, ag: topMargin + height}) : ((_Utils_cmp(currentHeight, (scrollTop + containerHeight) + offset) < 0) ? _Utils_update(
					calculatedTuple,
					{
						aB: newCurrentHeight,
					...
					calculatedTuple,
					{aB: newCurrentHeight, a3: idx + 1}));
			});
		var initialValue = {aB: 0, bA: 0, bB: _List_Nil, a3: 0, ag: 0};
			...
			case 8:
				...
				return _Utils_Tuple2(
					...
					$FabienHenon$elm_infinite_list_view$InfiniteList$scrollToNthItem(
						{
							dN: $Orange_OpenSource$elm_advanced_grid$Grid$infiniteListConfig(model),
							ee: targetItemIndex,
							eg: model.q,
...
var $rtfeldman$elm_css$Css$auto = {dB: 0, c: 0, aE: 0, bF: 0, eh: 0, aI: 0, aa: 0, S: 0, aL: 0, L: 0, bZ: 0, aQ: 0, F: 0, bo: 'auto'};
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F3(
	function (alt, ctrl, shift) {
		return {dC: alt, dS: ctrl, aM: shift};
	});
	...
	return $rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
				...
				$rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$contentBox),
				$rtfeldman$elm_css$Css$height(
				$rtfeldman$elm_css$Css$px(model.h.d5 - $Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth)),
...
var $rtfeldman$elm_css$Css$none = {aw: 0, cq: 0, z: 0, c: 0, m: 0, d7: 0, cS: 0, b5: 0, aK: 0, am: 0, S: 0, e: 0, d: 0, b8: 0, bR: 0, eD: 0, L: 0, bT: 0, eN: 0, aO: 0, at: 0, F: 0, k: 0, eY: 0, bo: 'none'};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewSortingSymbol = F2(
	function (model, columnConfig) {
		...
		if (!_v0.$) {
			var config = _v0.a;
			return _Utils_eq(config.b.R, columnConfig.b.R) ? ((model.ao === 2) ? $Orange_OpenSource$elm_advanced_grid$Grid$viewArrowUp : $Orange_OpenSource$elm_advanced_grid$Grid$viewArrowDown) : $Orange_OpenSource$elm_advanced_grid$Grid$noContent;
		} else {
...
var $rtfeldman$elm_css$Css$italic = {aF: 0, bo: 'italic'};
var $rtfeldman$elm_css$Css$normal = {b3: 0, aF: 0, _: 0, ca: 0, bo: 'normal', ai: 0};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewGhostHeader = function (model) {
	...
	if (!_v0.$) {
		...
		return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Css$px(draggedColumn.v - model.bD.v)),
			...
			_List_fromArray(
				[
					A3($Orange_OpenSource$elm_advanced_grid$Grid$viewDataHeader, model, draggedColumn.aY, _List_Nil)
				]));
	} else {
		return $Orange_OpenSource$elm_advanced_grid$Grid$noContent;
	}
	...
	function (model, currentColumn) {
		...
		if (!_v0.$) {
			...
			return _Utils_ap(
				...
				A2($Orange_OpenSource$elm_advanced_grid$Grid$isColumn, currentColumn, draggedColumn.aY) ? _List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[
					...
					[
						...
						$mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onEnter(
							function (_v1) {
								return A2($Orange_OpenSource$elm_advanced_grid$Grid$UserSwappedColumns, currentColumn, draggedColumn.aY);
							}))
					]));
		} else {
			return _List_Nil;
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewHeader = F3(
	function (model, columnConfig, index) {
		...
		var conditionalAttributes = _Utils_eq(model.af, $elm$core$Maybe$Nothing) ? _List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Events$onClick(
		...
		[
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Css$displayFlex,
					$rtfeldman$elm_css$Css$height(
					$rtfeldman$elm_css$Css$px(model.h.d5))
				])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$height(
								$rtfeldman$elm_css$Css$px(model.h.dP)),
								$rtfeldman$elm_css$Css$width(
								$rtfeldman$elm_css$Css$px(
									$Orange_OpenSource$elm_advanced_grid$Grid$gridWidth(model))),
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewGrid = function (model) {
	var conditionalAttributes = ((!_Utils_eq(model.af, $elm$core$Maybe$Nothing)) || (!_Utils_eq(model.I, $elm$core$Maybe$Nothing))) ? _List_fromArray(
		[
	...
	var attributes = _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$width(
					$rtfeldman$elm_css$Css$px(model.h.dQ + $Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth)),
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$px(5)),
						$rtfeldman$elm_css$Css$width(
						$rtfeldman$elm_css$Css$px(model.h.dQ * 0.6))
					]))
			]),
		A2(
			$elm$core$List$cons,
...
var $Orange_OpenSource$elm_advanced_grid$Grid$view = function (model) {
	return $rtfeldman$elm_css$Html$Styled$toUnstyled(
		model.bd ? $Orange_OpenSource$elm_advanced_grid$Grid$viewPreferences(model) : $Orange_OpenSource$elm_advanced_grid$Grid$viewGrid(model));
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$selectedAndVisibleItems = function (model) {
	return A2(
		$elm$core$List$filter,
		function ($) {
			return $.eP;
