...
{
	if (region.cd.a5 === region.cD.a5)
	{
		return 'on line ' + region.cd.a5;
	}
	return 'on lines ' + region.cd.a5 + ' through ' + region.cD.a5;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cI: fragment, cN: host, c7: path, c9: port_, dd: protocol, de: query};
	});
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {cx: s.cx + (newOffset - s.a8), f: s.f, g: s.g, a8: newOffset, dj: s.dj, a: s.a};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cx: col, dR: contextStack, da: problem, dj: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.dj, s.cx, x, s.f));
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.dj, s.cx - (floatOffset + s.a8), invalid, s.f));
		} else {
			if (_Utils_eq(s.a8, floatOffset)) {
				return A2(
					$elm$parser$Parser$Advanced$Bad,
					false,
				...
				if (_Utils_eq(intOffset, floatOffset)) {
					return A5($elm$parser$Parser$Advanced$finalizeInt, invalid, intSettings, s.a8, intPair, s);
				} else {
					if (floatSettings.$ === 1) {
						...
						var _v1 = $elm$core$String$toFloat(
							A3($elm$core$String$slice, s.a8, floatOffset, s.a));
						if (_v1.$ === 1) {
							return A2(
								$elm$parser$Parser$Advanced$Bad,
								true,
...
var $elm$parser$Parser$Advanced$number = function (c) {
	return function (s) {
		if (A3($elm$parser$Parser$Advanced$isAsciiCode, 48, s.a8, s.a)) {
			var zeroOffset = s.a8 + 1;
			...
			return A6(
				...
				c.cU,
				c.cH,
				A3($elm$parser$Parser$Advanced$consumeBase, 10, s.a8, s.a),
				s);
		}
	};
};
		...
		return $elm$parser$Parser$Advanced$number(
			{
				...
				cU: $elm$core$Result$Ok($elm$core$Basics$toFloat),
				eb: invalid,
	...
	function (isGood, offset, row, col, s0) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					$elm$parser$Parser$Advanced$Good,
					_Utils_cmp(s0.a8, offset) < 0,
					0,
					{cx: col, f: s0.f, g: s0.g, a8: offset, dj: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.a8, s.dj, s.cx, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.a8, s.dj, s.cx, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cx: newCol, f: s.f, g: s.g, a8: newOffset, dj: newRow, a: s.a});
	};
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$Filters$makeFilter = function (_v0) {
	...
	return {
		O: {
			...
			ad: A2($elm$parser$Parser$keeper, $Orange_OpenSource$elm_advanced_grid$Grid$Parsers$containsParser, typedParser)
		},
		P: {
			X: F2(
				function (value, item) {
			...
			ad: A2($elm$parser$Parser$keeper, $Orange_OpenSource$elm_advanced_grid$Grid$Parsers$equalityParser, typedParser)
		},
		Q: {
			X: F2(
				function (value, item) {
			...
			ad: A2($elm$parser$Parser$keeper, $Orange_OpenSource$elm_advanced_grid$Grid$Parsers$greaterThanParser, typedParser)
		},
		T: {
			X: F2(
				function (value, item) {
			...
			ad: A2($elm$parser$Parser$keeper, $Orange_OpenSource$elm_advanced_grid$Grid$Parsers$lessThanParser, typedParser)
		}
	};
};
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.dU) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.bK, record.dU, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	return {cv: charset, dV: finalDeclarations, cP: imports, c1: namespaces};
};
...
var $Skinney$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {ay: charsProcessed, aG: hash, ar: seed, aL: shift};
	});
...
var $Skinney$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.aG)) ? (data.ar ^ A2(
		$Skinney$murmur3$Murmur3$multiplyBy,
		$Skinney$murmur3$Murmur3$c2,
		A2(
			$Skinney$murmur3$Murmur3$rotlBy,
			15,
			A2($Skinney$murmur3$Murmur3$multiplyBy, $Skinney$murmur3$Murmur3$c1, data.aG)))) : data.ar;
	var h0 = acc ^ data.ay;
...
var $Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_v0 === 24) {
			...
			return {ay: data.ay + 1, aG: res, ar: data.ar, aL: data.aL + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {cv: charset, dV: declarations, cP: imports, c1: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {cv: $elm$core$Maybe$Nothing, cP: _List_Nil, c1: _List_Nil, dp: snippets};
};
...
var $rtfeldman$elm_css$Css$hidden = {z: 0, aK: 0, bo: 'hidden', bp: 0};
var $rtfeldman$elm_css$Css$inlineFlex = {m: 0, bo: 'inline-flex'};
...
var $rtfeldman$elm_css$Css$noWrap = {a0: 0, bC: 0, bo: 'nowrap', ai: 0};
...
var $rtfeldman$elm_css$Css$solid = {z: 0, as: 0, bo: 'solid'};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$floatColumnConfig = function (properties) {
	...
	var getter = properties.a1;
	var localize = properties.a6;
	...
	return {
		...
		aj: $Orange_OpenSource$elm_advanced_grid$Grid$Filters$FloatFilter(
		...
		eJ: $Orange_OpenSource$elm_advanced_grid$Grid$viewFloat(nestedDataGetter),
		aQ: A2($elm$core$Basics$composeR, nestedDataGetter, $elm$core$String$fromFloat)
	};
};
		...
		return $elm$parser$Parser$Advanced$number(
			{
				...
				cM: $elm$core$Result$Err(invalid),
				cU: $elm$core$Result$Ok($elm$core$Basics$identity),
				eb: invalid,
				c3: $elm$core$Result$Err(invalid)
			});
	});
...
var $Orange_OpenSource$elm_advanced_grid$Grid$intColumnConfig = function (properties) {
	...
	return {
		H: $Orange_OpenSource$elm_advanced_grid$Grid$compareFields(nestedDataGetter),
		D: $elm$core$Maybe$Nothing,
		aj: $Orange_OpenSource$elm_advanced_grid$Grid$Filters$IntFilter(
			$Orange_OpenSource$elm_advanced_grid$Grid$Filters$intFilter(getter)),
		b: $Orange_OpenSource$elm_advanced_grid$Grid$columnConfigProperties(properties),
		eJ: $Orange_OpenSource$elm_advanced_grid$Grid$viewInt(nestedDataGetter),
		aQ: A2($elm$core$Basics$composeR, nestedDataGetter, $elm$core$String$fromInt)
	};
};
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.a8, s.dj, s.cx, s.a);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		...
		return A3(
			$elm$parser$Parser$Advanced$Good,
			_Utils_cmp(s.a8, adjustedOffset) < 0,
			0,
			{cx: newCol, f: s.f, g: s.g, a8: adjustedOffset, dj: newRow, a: s.a});
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.a8, s1.a8, s0.a),
						a),
					s1);
			}
		};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$stringColumnConfig = function (properties) {
	...
	return {
		H: $Orange_OpenSource$elm_advanced_grid$Grid$compareFields(nestedDataGetter),
		D: $elm$core$Maybe$Nothing,
		aj: $Orange_OpenSource$elm_advanced_grid$Grid$Filters$StringFilter(
			$Orange_OpenSource$elm_advanced_grid$Grid$Filters$stringFilter(getter)),
		b: $Orange_OpenSource$elm_advanced_grid$Grid$columnConfigProperties(properties),
		eJ: $Orange_OpenSource$elm_advanced_grid$Grid$viewString(nestedDataGetter),
		aQ: nestedDataGetter
	};
};
...
var $rtfeldman$elm_css$Css$visible = {aK: 0, L: 0, bo: 'visible', bp: 0};
...
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$columns = _List_fromArray(
	[
		$Orange_OpenSource$elm_advanced_grid$Grid$intColumnConfig(
		{
			...
			R: 'Id',
			a6: $Orange_OpenSource$elm_advanced_grid$Examples$Basic$localize,
			bh: 'Id',
...
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$rowClass = function (item) {
	var even = _Utils_eq(item.cQ / 2, (item.cQ / 2) | 0);
	return item.eP ? 'selected-row' : (even ? 'even-row' : '');
};
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$gridConfig = {dI: true, dM: $Orange_OpenSource$elm_advanced_grid$Examples$Basic$columns, dP: 500, dQ: 676, d4: true, d5: 60, ej: 25, eL: $Orange_OpenSource$elm_advanced_grid$Examples$Basic$rowClass};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$Item$create = F2(
	function (data, index) {
		return {b0: data, cQ: index, eP: false};
	});
...
var $Orange_OpenSource$elm_advanced_grid$Grid$selectionColumn = function () {
	...
	return {
		...
		D: $elm$core$Maybe$Nothing,
		aj: $Orange_OpenSource$elm_advanced_grid$Grid$Filters$NoFilter,
		b: $Orange_OpenSource$elm_advanced_grid$Grid$columnConfigProperties(properties),
		eJ: $Orange_OpenSource$elm_advanced_grid$Grid$viewBool(
			function ($) {
				return $.eP;
			}),
		aQ: A2(
...
var $Orange_OpenSource$elm_advanced_grid$Grid$init = F2(
	function (config, data) {
		...
		var shouldAddSelectionColumn = config.dI && (!hasSelectionColumn(config.dM));
		var newConfig = shouldAddSelectionColumn ? _Utils_update(
			config,
			{
				dM: A2($elm$core$List$cons, $Orange_OpenSource$elm_advanced_grid$Grid$selectionColumn, config.dM)
			}) : config;
		var sanitizedConfig = _Utils_update(
			newConfig,
			{
				dM: $Orange_OpenSource$elm_advanced_grid$Grid$sanitizedColumns(newConfig.dM)
			});
		var initialState = {
		...
		return _Utils_update(
			initialState,
			{
				aY: $Orange_OpenSource$elm_advanced_grid$Grid$columnsX(initialState)
			});
	});
...
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$init = function (_v0) {
	return _Utils_Tuple2(
		{
			bw: $elm$core$Maybe$Nothing,
			j: A2($Orange_OpenSource$elm_advanced_grid$Grid$init, $Orange_OpenSource$elm_advanced_grid$Examples$Basic$gridConfig, $Orange_OpenSource$elm_advanced_grid$Examples$Basic$items)
		},
...
var $Orange_OpenSource$elm_advanced_grid$Grid$UserToggledAllItemSelection = {$: 22};
...
var $FabienHenon$elm_infinite_list_view$InfiniteList$config = function (conf) {
	return {bv: $elm$core$Maybe$Nothing, dP: conf.dP, a_: $FabienHenon$elm_infinite_list_view$InfiniteList$defaultContainer, R: $elm$core$Maybe$Nothing, ed: conf.ed, ef: conf.ef, a8: 200, bY: _List_Nil};
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewColumn = F2(
	function (config, item) {
		return A2(config.eJ, config.b, item);
	});
					...
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$displayFlex,
								$rtfeldman$elm_css$Css$height(
								$rtfeldman$elm_css$Css$px(state.h.ej)),
								$rtfeldman$elm_css$Css$width(
...
var $Orange_OpenSource$elm_advanced_grid$Grid$infiniteListConfig = function (state) {
	return A2(
		...
		$FabienHenon$elm_infinite_list_view$InfiniteList$config(
			{
				dP: state.h.dP,
				ed: $FabienHenon$elm_infinite_list_view$InfiniteList$withConstantHeight(state.h.ej),
...
var $elm$core$Array$appendHelpBuilder = F2(
	function (tail, builder) {
		...
		} : {r: builder.r, n: builder.n, q: appended});
	});
		...
		while (true) {
			...
			if (_Utils_cmp(
				...
				return A2(
					$elm$core$Array$builderToArray,
					true,
					{r: nodeList, n: nodeListSize, q: jsArray});
			} else {
			...
			case 2:
				return _Utils_Tuple2(
					$elm$core$List$reverse(
						A2($elm$core$List$sortWith, columnConfig.H, model.p)),
					2);
			case 1:
				return _Utils_Tuple2(
					A2($elm$core$List$sortWith, columnConfig.H, model.p),
					1);
			default:
				return _Utils_Tuple2(model.p, 0);
		}
	});
...
var $Orange_OpenSource$elm_advanced_grid$Grid$withColumnsXState = function (state) {
	return _Utils_update(
		state,
		{
			aY: $Orange_OpenSource$elm_advanced_grid$Grid$columnsX(state)
		});
};
		...
		return $Orange_OpenSource$elm_advanced_grid$Grid$withColumnsXState(
			A2(
				...
				_Utils_update(
					config,
					{
						dM: $Orange_OpenSource$elm_advanced_grid$Grid$sanitizedColumns(columns)
					}),
				state));
	});
...
var $Orange_OpenSource$elm_advanced_grid$Grid$resizeColumn = F2(
	function (state, x) {
		...
		if (!_v0.$) {
			...
			var newColumns = (_Utils_cmp(newWidth, $Orange_OpenSource$elm_advanced_grid$Grid$minColumnWidth) > 0) ? A3($Orange_OpenSource$elm_advanced_grid$Grid$updateColumnWidthProperty, state, columnConfig, newWidth) : state.h.dM;
...
var $Orange_OpenSource$elm_advanced_grid$Grid$sort = F4(
	function (model, columnConfig, order, sorter) {
		...
		return _Utils_update(
			...
			{
				ao: newOrder,
				be: $elm$core$Maybe$Just(columnConfig),
				p: updatedItems
			});
	});
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cx: col, da: problem, dj: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.dj, p.cx, p.da);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cx: 1, f: _List_Nil, g: 1, a8: 0, dj: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $Orange_OpenSource$elm_advanced_grid$Grid$Filters$validateContainsFilter = F2(
	function (filters, filteringString) {
		return A2(
			$elm$core$Result$map,
			filters.O.X,
			A2($elm$parser$Parser$run, filters.O.ad, filteringString));
	});
var $Orange_OpenSource$elm_advanced_grid$Grid$Filters$validateEqualFilter = F2(
	function (filters, filteringString) {
		return A2(
			$elm$core$Result$map,
			filters.P.X,
			A2($elm$parser$Parser$run, filters.P.ad, filteringString));
	});
var $Orange_OpenSource$elm_advanced_grid$Grid$Filters$validateGreaterThanFilter = F2(
	function (filters, filteringString) {
		return A2(
			$elm$core$Result$map,
			filters.Q.X,
			A2($elm$parser$Parser$run, filters.Q.ad, filteringString));
	});
var $Orange_OpenSource$elm_advanced_grid$Grid$Filters$validateLessThanFilter = F2(
	function (filters, filteringString) {
		return A2(
			$elm$core$Result$map,
			filters.T.X,
			A2($elm$parser$Parser$run, filters.T.ad, filteringString));
	});
...
var $Orange_OpenSource$elm_advanced_grid$Grid$columnFilters = function (model) {
	return A2(
		...
		function (c) {
			return A2($Orange_OpenSource$elm_advanced_grid$Grid$Filters$parseFilteringString, c.D, c.aj);
		},
		model.h.dM);
};
		...
		switch (msg.$) {
			...
			case 5:
				...
				if (!sortedColumnConfig.$) {
					...
					return A4($Orange_OpenSource$elm_advanced_grid$Grid$sort, state, columnConfig, sorting, $Orange_OpenSource$elm_advanced_grid$Grid$orderBy);
				} else {
					return state;
				}
			case 6:
			...
			case 14:
				...
				var draggedColumn = {aX: columnConfig, aB: mousePosition.v, bH: '', v: mousePosition.v};
				return A2(
			...
			case 11:
				var columnConfig = msg.a;
				return state.a$ ? state : A4($Orange_OpenSource$elm_advanced_grid$Grid$sort, state, columnConfig, state.ao, $Orange_OpenSource$elm_advanced_grid$Grid$toggleOrder);
			case 13:
				var item = msg.a;
				return _Utils_update(
					state,
			...
			case 19:
				return _Utils_update(
					state,
					{I: $elm$core$Maybe$Nothing, af: $elm$core$Maybe$Nothing});
			case 15:
				return state;
			case 20:
				var position = msg.a;
			...
			case 21:
				...
				if (!_v4.$) {
					...
					if (_Utils_eq(columnConfig.b.R, draggedColumn.bH)) {
						...
						var newColumns = A3($Orange_OpenSource$elm_advanced_grid$Grid$moveColumn, columnConfig, draggedColumnConfig, state.h.dM);
						return A2(
							$Orange_OpenSource$elm_advanced_grid$Grid$withDraggedColumn,
							$elm$core$Maybe$Just(
								_Utils_update(
			...
			case 22:
				...
				var updatedVisibleItems = A2($elm$core$List$map, setSelectionStatus, state.p);
				return _Utils_update(
					state,
					{bG: newStatus, p: updatedVisibleItems});
			case 23:
				var columnConfig = msg.a;
			...
			default:
				...
				var updatedData = A2($elm$core$List$map, updateContent, state.aZ);
		...
		var updateComputations = F2(
			function (item, calculatedTuple) {
				...
				return (_Utils_cmp(newCurrentHeight, scrollTop - offset) < 1) ? _Utils_update(
					calculatedTuple,
					{aA: newCurrentHeight, bA: elementsCountToSkip + 1, a3: idx + 1, ag: topMargin + height}) : ((_Utils_cmp(currentHeight, (scrollTop + containerHeight) + offset) < 0) ? _Utils_update(
					calculatedTuple,
					{
						aA: newCurrentHeight,
					...
					calculatedTuple,
					{aA: newCurrentHeight, a3: idx + 1}));
			});
		var initialValue = {aA: 0, bA: 0, bB: _List_Nil, a3: 0, ag: 0};
...
var $FabienHenon$elm_infinite_list_view$InfiniteList$computeElementsAndSizesForSimpleHeight = F4(
	function (_v0, itemHeight, scrollTop, items) {
		...
		return {bz: elementsToShow, bX: elementsCountToSkip, ag: topMargin, bj: totalHeight};
	});
var $FabienHenon$elm_infinite_list_view$InfiniteList$computeElementsAndSizes = F3(
	function (configValue, scrollTop, items) {
		...
		var customContainer = configValue.a_;
		if (!itemHeight.$) {
...
var $FabienHenon$elm_infinite_list_view$InfiniteList$scrollToNthItem = function (_v0) {
	var postScrollMessage = _v0.eG;
	var listHtmlId = _v0.ek;
	var itemIndex = _v0.ee;
	var configValue = _v0.dN;
	var items = _v0.eg;
	return A2(
		...
		switch (msg.$) {
			...
			case 8:
				...
				var targetItemIndex = A2(
					$elm$core$Maybe$withDefault,
					0,
					A2($elm_community$list_extra$List$Extra$findIndex, isTargetItem, state.p));
				return _Utils_Tuple2(
					state,
					$FabienHenon$elm_infinite_list_view$InfiniteList$scrollToNthItem(
						{
							dN: $Orange_OpenSource$elm_advanced_grid$Grid$infiniteListConfig(state),
							ee: targetItemIndex,
							eg: state.p,
							ek: $Orange_OpenSource$elm_advanced_grid$Grid$gridHtmlId,
							eG: $Orange_OpenSource$elm_advanced_grid$Grid$NoOp
						}));
			default:
				return _Utils_Tuple2(
...
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var _v1 = A2($Orange_OpenSource$elm_advanced_grid$Grid$update, $Orange_OpenSource$elm_advanced_grid$Grid$ShowPreferences, model.j);
			...
			case 1:
				switch (msg.a.$) {
					...
					case 22:
						var _v4 = msg.a;
						var _v5 = A2($Orange_OpenSource$elm_advanced_grid$Grid$update, $Orange_OpenSource$elm_advanced_grid$Grid$UserToggledAllItemSelection, model.j);
					...
					default:
						var message = msg.a;
						var _v6 = A2($Orange_OpenSource$elm_advanced_grid$Grid$update, message, model.j);
			...
			case 2:
				...
				var _v7 = A2($Orange_OpenSource$elm_advanced_grid$Grid$update, message, model.j);
			...
			case 3:
				...
				var _v8 = A2($Orange_OpenSource$elm_advanced_grid$Grid$update, message, model.j);
			...
			case 4:
				...
				var _v9 = A2($Orange_OpenSource$elm_advanced_grid$Grid$update, message, model.j);
			...
			case 5:
				...
				var _v10 = A2($Orange_OpenSource$elm_advanced_grid$Grid$update, message, model.j);
				...
				var message = $Orange_OpenSource$elm_advanced_grid$Grid$ScrollTo(
					function (item) {
						return A2(
							...
							$elm$core$String$toLower(item.b0.bu));
					});
				var _v11 = A2($Orange_OpenSource$elm_advanced_grid$Grid$update, message, model.j);
...
var $Orange_OpenSource$elm_advanced_grid$Grid$UserEndedMouseInteraction = {$: 19};
var $rtfeldman$elm_css$Css$auto = {dB: 0, c: 0, aD: 0, bF: 0, eh: 0, aH: 0, aa: 0, S: 0, aK: 0, L: 0, bZ: 0, aP: 0, F: 0, bo: 'auto'};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$defaultOptions = {cb: true, ce: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {dH: button, cw: clientPos, ei: keys, ew: offsetPos, eB: pagePos, eM: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F3(
	function (alt, ctrl, shift) {
		return {dC: alt, dS: ctrl, aL: shift};
	});
...
var $rtfeldman$elm_css$Css$relative = {bb: 0, bo: 'relative'};
var $rtfeldman$elm_css$Css$absolute = {bb: 0, bo: 'absolute'};
...
var $rtfeldman$elm_css$Css$row = {b4: 0, a0: 0, bo: 'row'};
	...
	return $rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
				...
				$rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$contentBox),
				$rtfeldman$elm_css$Css$height(
				$rtfeldman$elm_css$Css$px(state.h.d5 - $Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth)),
...
var $rtfeldman$elm_css$Css$none = {aw: 0, cq: 0, z: 0, c: 0, m: 0, d7: 0, cS: 0, b5: 0, aJ: 0, am: 0, S: 0, e: 0, d: 0, b8: 0, bR: 0, eD: 0, L: 0, bT: 0, eN: 0, aN: 0, at: 0, F: 0, k: 0, eY: 0, bo: 'none'};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$UserHoveredDragHandle = {$: 15};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$toPosition = function (event) {
	return {v: event.cw.a, br: event.cw.b};
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$UserClickedFilter = {$: 12};
				...
				[
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Css$width(
							$rtfeldman$elm_css$Css$px(columnConfig.b.bq - ($Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth * 2)))
						])),
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewSortingSymbol = F2(
	function (state, columnConfig) {
		...
		if (!_v0.$) {
			var config = _v0.a;
			return _Utils_eq(config.b.R, columnConfig.b.R) ? ((state.ao === 2) ? $Orange_OpenSource$elm_advanced_grid$Grid$viewArrowUp : $Orange_OpenSource$elm_advanced_grid$Grid$viewArrowDown) : $Orange_OpenSource$elm_advanced_grid$Grid$noContent;
		} else {
...
var $rtfeldman$elm_css$Css$italic = {aE: 0, bo: 'italic'};
var $rtfeldman$elm_css$Css$normal = {b3: 0, aE: 0, _: 0, ca: 0, bo: 'normal', ai: 0};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewGhostHeader = function (state) {
	...
	if (!_v0.$) {
		...
		return A2(
			...
			_List_fromArray(
				[
					A3($Orange_OpenSource$elm_advanced_grid$Grid$viewDataHeader, state, draggedColumn.aX, _List_Nil)
				]));
	} else {
		return $Orange_OpenSource$elm_advanced_grid$Grid$noContent;
	}
	...
	function (state, currentColumn) {
		...
		if (!_v0.$) {
			...
			return _Utils_ap(
				...
				A2($Orange_OpenSource$elm_advanced_grid$Grid$isColumn, currentColumn, draggedColumn.aX) ? _List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[
					...
					[
						...
						$mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onEnter(
							function (_v1) {
								return A2($Orange_OpenSource$elm_advanced_grid$Grid$UserSwappedColumns, currentColumn, draggedColumn.aX);
							}))
					]));
		} else {
			return _List_Nil;
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewHeader = F3(
	function (state, columnConfig, index) {
		...
		var conditionalAttributes = _Utils_eq(state.af, $elm$core$Maybe$Nothing) ? _List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Events$onClick(
		...
		[
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Css$displayFlex,
					$rtfeldman$elm_css$Css$height(
					$rtfeldman$elm_css$Css$px(state.h.d5))
				])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$height(
								$rtfeldman$elm_css$Css$px(state.h.dP)),
								$rtfeldman$elm_css$Css$width(
								$rtfeldman$elm_css$Css$px(
									$Orange_OpenSource$elm_advanced_grid$Grid$gridWidth(state))),
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewGrid = function (state) {
	var conditionalAttributes = ((!_Utils_eq(state.af, $elm$core$Maybe$Nothing)) || (!_Utils_eq(state.I, $elm$core$Maybe$Nothing))) ? _List_fromArray(
		[
	...
	var attributes = _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$width(
					$rtfeldman$elm_css$Css$px(state.h.dQ + $Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth)),
...
var $Orange_OpenSource$elm_advanced_grid$Grid$UserClickedPreferenceCloseButton = {$: 16};
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Html$Styled$Attributes$type_('checkbox'),
						$rtfeldman$elm_css$Html$Styled$Attributes$checked(columnConfig.b.au),
						$rtfeldman$elm_css$Html$Styled$Events$onClick(
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$px(5)),
						$rtfeldman$elm_css$Css$width(
						$rtfeldman$elm_css$Css$px(state.h.dQ * 0.6))
					]))
			]),
		A2(
			$elm$core$List$cons,
...
var $Orange_OpenSource$elm_advanced_grid$Grid$view = function (_v0) {
	...
	return $rtfeldman$elm_css$Html$Styled$toUnstyled(
		state.bd ? $Orange_OpenSource$elm_advanced_grid$Grid$viewPreferences(state) : $Orange_OpenSource$elm_advanced_grid$Grid$viewGrid(state));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$Orange_OpenSource$elm_advanced_grid$Grid$view(model.j))
			]));
};
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$DisplayPreferences = {$: 0};
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$ResetFilters = {$: 2};
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$SetAscendingOrder = {$: 4};
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$SetDecendingOrder = {$: 5};
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$SetFilters = {$: 3};
...
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$viewItem = function (item) {
	return $elm$html$Html$text(
		'id:' + ($elm$core$String$fromInt(item.b0.R) + (' - name: ' + (item.b0.bK + ''))));
};
...
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$viewSelectedItems = function (model) {
	var selectedItems = $Orange_OpenSource$elm_advanced_grid$Grid$selectedAndVisibleItems(model.j);
	return A2(
		$elm$html$Html$div,
...
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$viewMenu = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A3($Orange_OpenSource$elm_advanced_grid$Examples$Basic$viewButton, 'Show Preferences', 'showPreferencesButton', $Orange_OpenSource$elm_advanced_grid$Examples$Basic$DisplayPreferences),
...
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$main = $elm$browser$Browser$element(
	{
		...
		eX: $Orange_OpenSource$elm_advanced_grid$Examples$Basic$update,
		eZ: $Orange_OpenSource$elm_advanced_grid$Examples$Basic$view
	});
