	...
	return _List_fromArray(
		[
			...
			$Orange_OpenSource$elm_advanced_grid$Grid$intColumnConfig,
			{
				...
				id: 'Id',
				localize: $Orange_OpenSource$elm_advanced_grid$Examples$Basic$localize,
				setter: F2(
					function (item, _v0) {
						return item;
					}),
			...
			$Orange_OpenSource$elm_advanced_grid$Grid$stringColumnConfig,
			{
				editor: $elm$core$Maybe$Just(
					{fromString: $Orange_OpenSource$elm_advanced_grid$Examples$Basic$setCity, maxLength: 32}),
				getter: function ($) {
					return $.city;
				},
				id: 'City',
				localize: $Orange_OpenSource$elm_advanced_grid$Examples$Basic$localize,
				setter: $Orange_OpenSource$elm_advanced_grid$Examples$Basic$setCity,
				title: 'Ville',
...
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$gridConfig = {
	canSelectRows: true,
	columns: $Orange_OpenSource$elm_advanced_grid$Examples$Basic$columns($Orange_OpenSource$elm_advanced_grid$Examples$Basic$columnLabels),
	containerId: 'grid-container',
	footerHeight: 240,
	hasFilters: true,
	headerHeight: 60,
	labels: $Orange_OpenSource$elm_advanced_grid$Examples$Basic$translations,
	lineHeight: 25,
	rowClass: $Orange_OpenSource$elm_advanced_grid$Examples$Basic$rowClass
};
...
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$items = A2(
	...
	function (i) {
		return {
			...
			value: (i / $Orange_OpenSource$elm_advanced_grid$Examples$Basic$itemCount) * 100
		};
	},
...
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$init = function (_v0) {
	...
	var gridCmd = _v1.b;
	return _Utils_Tuple2(
		{arePreferencesVisible: false, clickedItem: $elm$core$Maybe$Nothing, gridModel: initialGridModel},
...
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$DisplayPreferences = {$: 'DisplayPreferences'};
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$HidePreferences = {$: 'HidePreferences'};
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$ResetFilters = {$: 'ResetFilters'};
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$SetAscendingOrder = {$: 'SetAscendingOrder'};
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$SetDecendingOrder = {$: 'SetDecendingOrder'};
var $Orange_OpenSource$elm_advanced_grid$Examples$Basic$SetFilters = {$: 'SetFilters'};
