...
var pascallemerrer$elm_advanced_grid$Examples$LargeList$init = function (_n0) {
	return _Utils_Tuple2(
		{
			clickedItem: elm$core$Maybe$Nothing,
			gridModel: A2(pascallemerrer$elm_advanced_grid$Grid$init, pascallemerrer$elm_advanced_grid$Examples$LargeList$gridConfig, pascallemerrer$elm_advanced_grid$Examples$LargeList$items),
...
var pascallemerrer$elm_advanced_grid$Examples$LargeList$DisplayPreferences = {$: 'DisplayPreferences'};
var pascallemerrer$elm_advanced_grid$Examples$LargeList$ResetFilters = {$: 'ResetFilters'};
var pascallemerrer$elm_advanced_grid$Examples$LargeList$SetAscendingOrder = {$: 'SetAscendingOrder'};
var pascallemerrer$elm_advanced_grid$Examples$LargeList$SetDecendingOrder = {$: 'SetDecendingOrder'};
var pascallemerrer$elm_advanced_grid$Examples$LargeList$SetFilters = {$: 'SetFilters'};
...
var pascallemerrer$elm_advanced_grid$Examples$LargeList$main = elm$browser$Browser$element(
	{
		init: pascallemerrer$elm_advanced_grid$Examples$LargeList$init,
		subscriptions: function (_n0) {
			return elm$core$Platform$Sub$none;
		},
		update: pascallemerrer$elm_advanced_grid$Examples$LargeList$update,
		view: pascallemerrer$elm_advanced_grid$Examples$LargeList$view
	});
