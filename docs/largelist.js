...
{
	if (region.cA.bl === region.cZ.bl)
	{
		return 'on line ' + region.cA.bl;
	}
	return 'on lines ' + region.cA.bl + ' through ' + region.cZ.bl;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ev: 'hidden', d4: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ev: 'mozHidden', d4: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ev: 'msHidden', d4: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ev: 'webkitHidden', d4: 'webkitvisibilitychange' }
		: { ev: 'hidden', d4: 'visibilitychange' };
}
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cU: col, f: s0.f, i: s0.i, bo: offset, dE: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.bo, s.dE, s.cU, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cU: col, ed: contextStack, dv: problem, dE: row};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.bo, s.dE, s.cU, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cU: newCol, f: s.f, i: s.i, bo: newOffset, dE: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.bo, s.dE, s.cU, s.a);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		...
		return A3(
			...
			0,
			{cU: newCol, f: s.f, i: s.i, bo: adjustedOffset, dE: newRow, a: s.a});
	};
};
...
var $rtfeldman$elm_css$Css$prop1 = F2(
	function (key, arg) {
		return A2($rtfeldman$elm_css$Css$property, key, arg.fm);
	});
...
var $rtfeldman$elm_css$Css$contentBox = {ck: 0, bI: 0, fm: 'content-box'};
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.eg) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.bm, record.eg, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	return {cS: charset, eh: finalDeclarations, c9: imports, dm: namespaces};
};
...
var $Skinney$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {aQ: charsProcessed, aZ: hash, aE: seed, a2: shift};
	});
...
var $Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_v0 === 24) {
			...
			return {aQ: data.aQ + 1, aZ: res, aE: data.aE, a2: data.a2 + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {cS: charset, eh: declarations, c9: imports, dm: namespaces};
};
...
var $rtfeldman$elm_css$Css$visible = {a1: 0, T: 0, fm: 'visible', bG: 0};
...
var $rtfeldman$elm_css$Css$hidden = {I: 0, a1: 0, fm: 'hidden', bG: 0};
...
var $rtfeldman$elm_css$Css$inlineFlex = {o: 0, fm: 'inline-flex'};
...
var $rtfeldman$elm_css$Css$erroneousHex = function (str) {
	return {
		...
		cq: 0,
		cy: 0,
		fm: $rtfeldman$elm_css$Css$withPrecedingHash(str)
	};
};
...
var $rtfeldman$elm_css$Css$solid = {I: 0, aG: 0, fm: 'solid'};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {cU: s.cU + (newOffset - s.bo), f: s.f, i: s.i, bo: newOffset, dE: s.dE, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.dE, s.cU - (floatOffset + s.bo), invalid, s.f));
		} else {
...
var $rtfeldman$elm_css$Css$backgroundColor = function (c) {
	return A2($rtfeldman$elm_css$Css$property, 'background-color', c.fm);
};
...
var $Orange_OpenSource$elm_advanced_grid$Examples$LargeList$rowClass = function (item) {
	...
	return item.fc ? 'selected-row' : (even ? 'even-row' : '');
};
var $Orange_OpenSource$elm_advanced_grid$Examples$LargeList$gridConfig = {
	d3: true,
	d7: $Orange_OpenSource$elm_advanced_grid$Examples$LargeList$columns($elm$core$Dict$empty),
	ea: 500,
	eb: 950,
	es: true,
	et: 60,
	...
	eJ: 25,
	e8: $Orange_OpenSource$elm_advanced_grid$Examples$LargeList$rowClass
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$Item$create = F2(
	function (data, contentIndex) {
		return {ec: contentIndex, bf: data, fc: false, dV: contentIndex};
	});
		...
		ay: F2(
			function (item, value) {
				return _Utils_update(
					item,
					{
						fc: $Orange_OpenSource$elm_advanced_grid$Grid$stringToBool(value)
					});
			}),
		aj: false,
		b: $Orange_OpenSource$elm_advanced_grid$Grid$columnConfigProperties(properties),
...
var $FabienHenon$elm_infinite_list_view$InfiniteList$config = function (conf) {
	return {bK: $elm$core$Maybe$Nothing, ea: conf.ea, be: $FabienHenon$elm_infinite_list_view$InfiniteList$defaultContainer, n: $elm$core$Maybe$Nothing, eC: conf.eC, eE: conf.eE, bo: 200, ch: _List_Nil};
};
			...
			$rtfeldman$elm_css$Html$Styled$div(
				_List_fromArray(
					[
						...
						state.bg ? $Orange_OpenSource$elm_advanced_grid$Grid$NoOp : $Orange_OpenSource$elm_advanced_grid$Grid$UserClickedLine(item))
					])),
			A2(
				$elm$core$List$map,
				function (columnConfig) {
...
var $FabienHenon$elm_infinite_list_view$InfiniteList$computeElementsAndSizesForMultipleHeights = F4(
	function (_v0, getHeight, scrollTop, items) {
		...
		var updateComputations = F2(
			function (item, calculatedTuple) {
				...
				return (_Utils_cmp(
					...
					calculatedTuple,
					{aS: newCurrentHeight, bT: elementsCountToSkip + 1, bi: idx + 1, ar: topMargin + height}) : ((_Utils_cmp(
					currentHeight,
		...
		var initialValue = {aS: 0, bT: 0, bU: _List_Nil, bi: 0, ar: 0};
...
var $FabienHenon$elm_infinite_list_view$InfiniteList$computeElementsAndSizesForSimpleHeight = F4(
	function (_v0, itemHeight, scrollTop, items) {
		...
		return {bS: elementsToShow, cg: elementsCountToSkip, ar: topMargin, bw: totalHeight};
	});
...
var $Orange_OpenSource$elm_advanced_grid$Grid$closeQuickFilter = function (state) {
	return _Utils_update(
		state,
		{af: false, bp: $elm$core$Maybe$Nothing});
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$resizeColumn = F2(
	function (state, x) {
		...
		if (!_v0.$) {
			...
			var newColumns = (_Utils_cmp(newWidth, $Orange_OpenSource$elm_advanced_grid$Grid$minColumnWidth) > 0) ? A3($Orange_OpenSource$elm_advanced_grid$Grid$updateColumnWidthProperty, state, columnConfig, newWidth) : state.g.d7;
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cU: 1, f: _List_Nil, i: 1, bo: 0, dE: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (msg, state) {
		switch (msg.$) {
			...
			case 5:
				if (!msg.a.$) {
					var info = msg.a.a;
					var position = {t: info.aU.t, aM: info.aU.aM};
					var dimensions = {c5: info.aU.c5, B: info.aU.B};
					var updatedStringEditor = A2(
						$Orange_OpenSource$elm_advanced_grid$Grid$StringEditor$update,
			...
			case 18:
				...
				var draggedColumn = {bc: columnConfig, aT: mousePosition.t, b1: '', t: mousePosition.t};
				return A2(
				...
				switch (msg.a.$) {
					...
					case 4:
						...
						var updateEditedValue = F2(
							function (index, item) {
								return _Utils_eq(index, editedItem.ec) ? A2(editedColumn.ay, editedItem, state.aq.fm).bf : item;
							});
			...
			case 26:
				...
				if (!_v4.$) {
					...
					if (_Utils_eq(columnConfig.b.n, draggedColumn.b1)) {
						...
						var newColumns = A3($Orange_OpenSource$elm_advanced_grid$Grid$moveColumn, columnConfig, draggedColumnConfig, state.g.d7);
						return A2(
							$Orange_OpenSource$elm_advanced_grid$Grid$withDraggedColumn,
							$elm$core$Maybe$Just(
								_Utils_update(
				...
				var message = $Orange_OpenSource$elm_advanced_grid$Grid$ScrollTo(
					function (item) {
						return A2(
							...
							$elm$core$String$toLower(item.bf.bJ));
					});
...
var $rtfeldman$elm_css$Css$auto = {dY: 0, c: 0, aW: 0, b_: 0, eG: 0, a_: 0, ak: 0, Z: 0, a1: 0, T: 0, ci: 0, a6: 0, N: 0, fm: 'auto'};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {d2: button, cT: clientPos, eH: keys, eW: offsetPos, e$: pagePos, e9: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F3(
	function (alt, ctrl, shift) {
		return {dZ: alt, ee: ctrl, a2: shift};
	});
...
var $rtfeldman$elm_css$Css$relative = {bs: 0, fm: 'relative'};
var $rtfeldman$elm_css$Css$absolute = {bs: 0, fm: 'absolute'};
...
var $rtfeldman$elm_css$Css$row = {cp: 0, bh: 0, fm: 'row'};
...
var $rtfeldman$elm_css$Css$none = {aO: 0, cN: 0, I: 0, c: 0, o: 0, ew: 0, db: 0, cr: 0, a0: 0, az: 0, Z: 0, e: 0, d: 0, cu: 0, ca: 0, e1: 0, T: 0, cc: 0, fa: 0, a4: 0, aH: 0, N: 0, k: 0, fl: 0, fm: 'none'};
...
var $rtfeldman$elm_css$Css$int = function (val) {
	return {
		...
		a7: '',
		bA: 0,
		fm: $elm$core$String$fromInt(val)
	};
};
var $rtfeldman$elm_css$Css$marginBottom = $rtfeldman$elm_css$Css$prop1('margin-bottom');
var $rtfeldman$elm_css$Css$marginRight = $rtfeldman$elm_css$Css$prop1('margin-right');
var $rtfeldman$elm_css$Css$move = {c: 0, fm: 'move'};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$toPosition = function (event) {
	return {t: event.cT.a, aM: event.cT.b};
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$filterInputWidth = function (columnConfig) {
	return $rtfeldman$elm_css$Css$px(
		(columnConfig.b.B - ($Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth * 2)) - (columnConfig.aj ? 30 : 0));
};
...
var $rtfeldman$elm_css$Css$pointer = {c: 0, fm: 'pointer'};
...
var $rtfeldman$elm_css$Css$italic = {aX: 0, fm: 'italic'};
var $Orange_OpenSource$elm_advanced_grid$Grid$Colors$lightGrey3 = $rtfeldman$elm_css$Css$hex('DDD');
var $rtfeldman$elm_css$Css$normal = {co: 0, aX: 0, ai: 0, cw: 0, fm: 'normal', at: 0};
...
var $rtfeldman$elm_css$Css$color = function (c) {
	return A2($rtfeldman$elm_css$Css$property, 'color', c.fm);
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewResetSelector = F2(
	function (columnConfig, label) {
		var params = {bM: columnConfig, bV: '', bW: $elm$core$Maybe$Nothing, b0: true, bj: label};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewOpenedQuickFilter = F2(
	function (state, columnConfig) {
		...
		var emptyLabel = A2($Orange_OpenSource$elm_advanced_grid$Grid$Labels$localize, $Orange_OpenSource$elm_advanced_grid$Grid$Labels$empty, state.eI);
			...
			_Utils_ap(
				...
				_Utils_ap(
					...
					A2(
						...
						columnConfig,
						A2($Orange_OpenSource$elm_advanced_grid$Grid$Labels$localize, $Orange_OpenSource$elm_advanced_grid$Grid$Labels$clear, state.eI)))));
	});
...
var $rtfeldman$elm_css$Css$colResize = {c: 0, fm: 'col-resize'};
...
var $rtfeldman$elm_css$Css$transparent = {V: 0, fm: 'transparent'};
					...
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$absolute),
								$rtfeldman$elm_css$Css$left(
								$rtfeldman$elm_css$Css$px(draggedColumn.t - state.bY.t)),
								$rtfeldman$elm_css$Css$top(
								$rtfeldman$elm_css$Css$px(2)),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$height(
						$rtfeldman$elm_css$Css$px(state.g.ea)),
						$rtfeldman$elm_css$Css$width(
						$rtfeldman$elm_css$Css$px(
							$Orange_OpenSource$elm_advanced_grid$Grid$gridWidth(state))),
						$rtfeldman$elm_css$Css$overflowX($rtfeldman$elm_css$Css$hidden),
	...
	var attributes = _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$width(
					$rtfeldman$elm_css$Css$px(state.g.eb + $Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth)),
...
var $rtfeldman$elm_css$Css$valuesOrNone = function (list) {
	return $elm$core$List$isEmpty(list) ? {fm: 'none'} : {
		fm: A2(
			$elm$core$String$join,
			' ',
			A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$px(5)),
						$rtfeldman$elm_css$Css$width(
						$rtfeldman$elm_css$Css$px(state.g.eb * 0.6))
					]))
			]),
		A2(
			$elm$core$List$cons,
						...
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$absolute),
									$rtfeldman$elm_css$Css$left(
									$rtfeldman$elm_css$Css$px(model.bs.t)),
									$rtfeldman$elm_css$Css$top(
									$rtfeldman$elm_css$Css$px(model.bs.aM))
								])),
								...
								[
									...
									_List_fromArray(
										[
											...
											$rtfeldman$elm_css$Css$width(
											$rtfeldman$elm_css$Css$px(model.bO.B - 9)),
											$rtfeldman$elm_css$Css$paddingLeft(
											$rtfeldman$elm_css$Css$px(2)),
											$rtfeldman$elm_css$Css$margin(
											$rtfeldman$elm_css$Css$px(0))
									...
									$rtfeldman$elm_css$Html$Styled$Attributes$value(model.fm)
								]),
							_List_Nil)
						]))
				]));
...
var $Orange_OpenSource$elm_advanced_grid$Examples$LargeList$main = $elm$browser$Browser$element(
	{
		...
		fk: $Orange_OpenSource$elm_advanced_grid$Examples$LargeList$update,
