...
{
	if (region.ci.ba === region.cJ.ba)
	{
		return 'on line ' + region.ci.ba;
	}
	return 'on lines ' + region.ci.ba + ' through ' + region.cJ.ba;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ec: 'hidden', dP: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ec: 'mozHidden', dP: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ec: 'msHidden', dP: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ec: 'webkitHidden', dP: 'webkitvisibilitychange' }
		: { ec: 'hidden', dP: 'visibilitychange' };
}
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cO: fragment, cS: host, dc: path, de: port_, di: protocol, dj: query};
	});
...
var rtfeldman$elm_css$Css$erroneousHex = function (str) {
	return {
		...
		a7: 0,
		bg: 0,
		V: rtfeldman$elm_css$Css$withPrecedingHash(str)
	};
};
...
var rtfeldman$elm_css$Css$contentBox = {b5: 0, bz: 0, V: 'content-box'};
var rtfeldman$elm_css$Css$display = rtfeldman$elm_css$Css$prop1('display');
var rtfeldman$elm_css$Css$hidden = {D: 0, aP: 0, V: 'hidden', bw: 0};
var rtfeldman$elm_css$Css$inlineFlex = {n: 0, V: 'inline-flex'};
var rtfeldman$elm_css$Css$minHeight = rtfeldman$elm_css$Css$prop1('min-height');
var rtfeldman$elm_css$Css$noWrap = {a6: 0, bJ: 0, V: 'nowrap', aj: 0};
...
var rtfeldman$elm_css$Css$solid = {D: 0, au: 0, V: 'solid'};
...
var Skinney$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {aB: charsProcessed, aK: hash, at: seed, aT: shift};
	});
...
var Skinney$murmur3$Murmur3$finalize = function (data) {
	var acc = data.aK ? (data.at ^ A2(
		Skinney$murmur3$Murmur3$multiplyBy,
		Skinney$murmur3$Murmur3$c2,
		A2(
			Skinney$murmur3$Murmur3$rotlBy,
			15,
			A2(Skinney$murmur3$Murmur3$multiplyBy, Skinney$murmur3$Murmur3$c1, data.aK)))) : data.at;
	var h0 = acc ^ data.aB;
...
var Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data.aK | ((255 & elm$core$Char$toCode(c)) << data.aT);
		var _n0 = data.aT;
		if (_n0 === 24) {
			return {
				aB: data.aB + 1,
			...
			return {aB: data.aB + 1, aK: res, at: data.at, aT: data.aT + 8};
		}
	});
...
var rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {cA: elm$core$Maybe$Nothing, cU: _List_Nil, c6: _List_Nil, dv: snippets};
};
...
var rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_n0) {
	...
	var declarations = rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2(elm$core$List$concatMap, rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {cA: charset, d$: declarations, cU: imports, c6: namespaces};
};
	...
	function (declaration, _n0) {
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return elm$core$String$isEmpty(record.d_) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3(elm$core$Dict$insert, record.bQ, record.d_, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_n0) {
	...
	return {cA: charset, d$: finalDeclarations, cU: imports, c6: namespaces};
};
	...
	function (isGood, offset, row, col, s0) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					elm$parser$Parser$Advanced$Good,
					_Utils_cmp(s0.bc, offset) < 0,
					0,
					{cC: col, f: s0.f, g: s0.g, bc: offset, $7: row, a: s0.a});
			} else {
...
var elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5(elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.bc, s.$7, s.cC, s);
	};
};
...
var elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cC: col, dX: contextStack, df: problem, $7: row};
	});
...
var elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4(elm$parser$Parser$Advanced$DeadEnd, s.$7, s.cC, x, s.f));
	});
...
var elm$parser$Parser$Advanced$token = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, str, s.bc, s.$7, s.cC, s.a);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cC: newCol, f: s.f, g: s.g, bc: newOffset, $7: newRow, a: s.a});
	};
};
...
var pascallemerrer$elm_advanced_grid$Grid$Filters$makeFilter = function (_n0) {
	...
	var equal = _n0.Q;
	var lessThan = _n0.T;
	var greaterThan = _n0.R;
	var contains = _n0.P;
	var typedParser = _n0.bn;
	return {
		P: {
			Y: F2(
				function (value, item) {
			...
			af: A2(elm$parser$Parser$keeper, pascallemerrer$elm_advanced_grid$Grid$Parsers$containsParser, typedParser)
		},
		Q: {
			Y: F2(
				function (value, item) {
			...
			af: A2(elm$parser$Parser$keeper, pascallemerrer$elm_advanced_grid$Grid$Parsers$equalityParser, typedParser)
		},
		R: {
			Y: F2(
				function (value, item) {
			...
			af: A2(elm$parser$Parser$keeper, pascallemerrer$elm_advanced_grid$Grid$Parsers$greaterThanParser, typedParser)
		},
		T: {
			Y: F2(
				function (value, item) {
			...
			af: A2(elm$parser$Parser$keeper, pascallemerrer$elm_advanced_grid$Grid$Parsers$lessThanParser, typedParser)
		}
	};
};
var elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _n0 = A5(_Parser_findSubString, str, s.bc, s.$7, s.cC, s.a);
		var newOffset = _n0.a;
		var newRow = _n0.b;
		var newCol = _n0.c;
		...
		return A3(
			elm$parser$Parser$Advanced$Good,
			_Utils_cmp(s.bc, adjustedOffset) < 0,
			0,
			{cC: newCol, f: s.f, g: s.g, bc: adjustedOffset, $7: newRow, a: s.a});
	};
};
		...
		return function (s0) {
			...
			if (_n1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3(elm$core$String$slice, s0.bc, s1.bc, s0.a),
						a),
					s1);
			}
		};
...
var pascallemerrer$elm_advanced_grid$Grid$stringColumnConfig = function (properties) {
	...
	var nestedDataGetter = A2(
		...
		getter);
	return {
		J: pascallemerrer$elm_advanced_grid$Grid$compareFields(nestedDataGetter),
		G: elm$core$Maybe$Nothing,
		ak: pascallemerrer$elm_advanced_grid$Grid$Filters$StringFilter(
		...
		as: pascallemerrer$elm_advanced_grid$Grid$viewString(nestedDataGetter),
		aY: nestedDataGetter
	};
};
...
var elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {cC: s.cC + (newOffset - s.bc), f: s.f, g: s.g, bc: newOffset, $7: s.$7, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				elm$parser$Parser$Advanced$Bad,
				true,
				A4(elm$parser$Parser$Advanced$fromInfo, s.$7, s.cC - (floatOffset + s.bc), invalid, s.f));
		} else {
			if (_Utils_eq(s.bc, floatOffset)) {
				return A2(
					elm$parser$Parser$Advanced$Bad,
					false,
				...
				if (_Utils_eq(intOffset, floatOffset)) {
					return A5(elm$parser$Parser$Advanced$finalizeInt, invalid, intSettings, s.bc, intPair, s);
				} else {
					if (floatSettings.$ === 1) {
						...
						var _n1 = elm$core$String$toFloat(
							A3(elm$core$String$slice, s.bc, floatOffset, s.a));
						if (_n1.$ === 1) {
							return A2(
								elm$parser$Parser$Advanced$Bad,
								true,
...
var elm$parser$Parser$Advanced$number = function (c) {
	return function (s) {
		if (A3(elm$parser$Parser$Advanced$isAsciiCode, 48, s.bc, s.a)) {
			var zeroOffset = s.bc + 1;
			...
			return A6(
				...
				c.cZ,
				c.cN,
				A3(elm$parser$Parser$Advanced$consumeBase, 10, s.bc, s.a),
				s);
		}
	};
};
...
var pascallemerrer$elm_advanced_grid$Grid$intColumnConfig = function (properties) {
	...
	return {
		J: pascallemerrer$elm_advanced_grid$Grid$compareFields(nestedDataGetter),
		G: elm$core$Maybe$Nothing,
		ak: pascallemerrer$elm_advanced_grid$Grid$Filters$IntFilter(
			pascallemerrer$elm_advanced_grid$Grid$Filters$intFilter(nestedDataGetter)),
		b: pascallemerrer$elm_advanced_grid$Grid$columnConfigProperties(properties),
		as: pascallemerrer$elm_advanced_grid$Grid$viewInt(nestedDataGetter),
		...
		return elm$parser$Parser$Advanced$number(
			{
				...
				cR: elm$core$Result$Err(invalid),
				cZ: elm$core$Result$Ok(elm$core$Basics$toFloat),
				eh: invalid,
				c8: elm$core$Result$Err(invalid)
			});
	});
...
var pascallemerrer$elm_advanced_grid$Grid$floatColumnConfig = function (properties) {
	...
	return {
		J: pascallemerrer$elm_advanced_grid$Grid$compareFields(nestedDataGetter),
		G: elm$core$Maybe$Nothing,
		ak: pascallemerrer$elm_advanced_grid$Grid$Filters$FloatFilter(
			pascallemerrer$elm_advanced_grid$Grid$Filters$floatFilter(nestedDataGetter)),
		b: pascallemerrer$elm_advanced_grid$Grid$columnConfigProperties(properties),
		as: pascallemerrer$elm_advanced_grid$Grid$viewFloat(nestedDataGetter),
...
var rtfeldman$elm_css$Css$visible = {aP: 0, M: 0, V: 'visible', bw: 0};
...
var pascallemerrer$elm_advanced_grid$Examples$LargeList$rowClass = function (item) {
	var even = _Utils_eq(item.cV / 2, (item.cV / 2) | 0);
	return item.ds ? 'selected-row' : (even ? 'even-row' : '');
};
var pascallemerrer$elm_advanced_grid$Examples$LargeList$gridConfig = {dO: true, dS: pascallemerrer$elm_advanced_grid$Examples$LargeList$columns, dV: 500, dW: 950, ea: true, eb: 60, eq: 25, eR: pascallemerrer$elm_advanced_grid$Examples$LargeList$rowClass};
...
var pascallemerrer$elm_advanced_grid$Examples$LargeList$items = A2(
	...
	function (i) {
		return {
			...
			aw: ((pascallemerrer$elm_advanced_grid$Examples$LargeList$itemCount - i) / pascallemerrer$elm_advanced_grid$Examples$LargeList$itemCount) * 100,
...
var elm$parser$Parser$Advanced$keyword = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, kwd, s.bc, s.$7, s.cC, s.a);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
...
var pascallemerrer$elm_advanced_grid$Grid$Filters$boolFilter = function (getter) {
	return pascallemerrer$elm_advanced_grid$Grid$Filters$makeFilter(
		{P: elm$core$Basics$eq, Q: elm$core$Basics$eq, t: getter, R: pascallemerrer$elm_advanced_grid$Grid$Filters$boolGreaterThan, T: pascallemerrer$elm_advanced_grid$Grid$Filters$boolLessThan, bn: pascallemerrer$elm_advanced_grid$Grid$Parsers$boolParser});
};
var pascallemerrer$elm_advanced_grid$Grid$selectionColumn = function () {
	...
	return {
		J: pascallemerrer$elm_advanced_grid$Grid$compareBoolField(
			function ($) {
				return $.ds;
			}),
		G: elm$core$Maybe$Nothing,
		ak: pascallemerrer$elm_advanced_grid$Grid$Filters$BoolFilter(
			pascallemerrer$elm_advanced_grid$Grid$Filters$boolFilter(
				function ($) {
					return $.ds;
				})),
		b: pascallemerrer$elm_advanced_grid$Grid$columnConfigProperties(properties),
		as: pascallemerrer$elm_advanced_grid$Grid$viewBool(
			function ($) {
				return $.ds;
			}),
		aY: A2(
...
var pascallemerrer$elm_advanced_grid$Grid$init = F2(
	function (config, data) {
		...
		var shouldAddSelectionColumn = config.dO && (!hasSelectionColumn(config.dS));
		...
		return _Utils_update(
			initialModel,
			{
				aD: pascallemerrer$elm_advanced_grid$Grid$columnsX(initialModel)
			});
	});
var pascallemerrer$elm_advanced_grid$Examples$LargeList$init = function (_n0) {
	return _Utils_Tuple2(
		{
			bC: elm$core$Maybe$Nothing,
...
var FabienHenon$elm_infinite_list_view$InfiniteList$computeElementsAndSizesForMultipleHeights = F4(
	function (_n0, getHeight, scrollTop, items) {
		var offset = _n0.bc;
		var containerHeight = _n0.dV;
		var updateComputations = F2(
			function (item, calculatedTuple) {
				var _n1 = calculatedTuple;
				var idx = _n1.a8;
				var elementsCountToSkip = _n1.bH;
				var elementsToShow = _n1.bI;
				var topMargin = _n1.ah;
				var currentHeight = _n1.aE;
				...
				return (_Utils_cmp(newCurrentHeight, scrollTop - offset) < 1) ? _Utils_update(
					calculatedTuple,
					{aE: newCurrentHeight, bH: elementsCountToSkip + 1, a8: idx + 1, ah: topMargin + height}) : ((_Utils_cmp(currentHeight, (scrollTop + containerHeight) + offset) < 0) ? _Utils_update(
					calculatedTuple,
					{
						aE: newCurrentHeight,
					...
					calculatedTuple,
					{aE: newCurrentHeight, a8: idx + 1}));
			});
		var initialValue = {aE: 0, bH: 0, bI: _List_Nil, a8: 0, ah: 0};
		...
		return {
			...
			b1: computedValues.bH,
			ah: computedValues.ah,
			bm: computedValues.aE
		};
	});
var FabienHenon$elm_infinite_list_view$InfiniteList$computeElementsAndSizesForSimpleHeight = F4(
	function (_n0, itemHeight, scrollTop, items) {
		...
		return {bG: elementsToShow, b1: elementsCountToSkip, ah: topMargin, bm: totalHeight};
	});
var FabienHenon$elm_infinite_list_view$InfiniteList$computeElementsAndSizes = F3(
	function (configValue, scrollTop, items) {
		...
		var customContainer = configValue.a4;
		if (!itemHeight.$) {
...
var FabienHenon$elm_infinite_list_view$InfiniteList$scrollToNthItem = function (_n0) {
	var postScrollMessage = _n0.eN;
	var listHtmlId = _n0.er;
	var itemIndex = _n0.el;
	var configValue = _n0.dT;
	var items = _n0.en;
	return A2(
...
var elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cC: col, df: problem, $7: row};
	});
var elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3(elm$parser$Parser$DeadEnd, p.$7, p.cC, p.df);
};
...
var elm$parser$Parser$Advanced$run = F2(
	function (_n0, src) {
		var parse = _n0;
		var _n1 = parse(
			{cC: 1, f: _List_Nil, g: 1, bc: 0, $7: 1, a: src});
		if (!_n1.$) {
			var value = _n1.b;
...
var pascallemerrer$elm_advanced_grid$Grid$Filters$validateContainsFilter = F2(
	function (filters, filteringString) {
		return A2(
			elm$core$Result$map,
			filters.P.Y,
			A2(elm$parser$Parser$run, filters.P.af, filteringString));
	});
var pascallemerrer$elm_advanced_grid$Grid$Filters$validateEqualFilter = F2(
	function (filters, filteringString) {
		return A2(
			elm$core$Result$map,
			filters.Q.Y,
			A2(elm$parser$Parser$run, filters.Q.af, filteringString));
	});
var pascallemerrer$elm_advanced_grid$Grid$Filters$validateGreaterThanFilter = F2(
	function (filters, filteringString) {
		return A2(
			elm$core$Result$map,
			filters.R.Y,
			A2(elm$parser$Parser$run, filters.R.af, filteringString));
	});
var pascallemerrer$elm_advanced_grid$Grid$Filters$validateLessThanFilter = F2(
	function (filters, filteringString) {
		return A2(
			elm$core$Result$map,
			filters.T.Y,
			A2(elm$parser$Parser$run, filters.T.af, filteringString));
	});
...
var pascallemerrer$elm_advanced_grid$Grid$columnFilters = function (model) {
	return A2(
		...
		function (c) {
			return A2(pascallemerrer$elm_advanced_grid$Grid$Filters$parseFilteringString, c.G, c.ak);
		},
		model.h.dS);
};
...
var FabienHenon$elm_infinite_list_view$InfiniteList$config = function (conf) {
	return {bB: elm$core$Maybe$Nothing, dV: conf.dV, a4: FabienHenon$elm_infinite_list_view$InfiniteList$defaultContainer, m: elm$core$Maybe$Nothing, ek: conf.ek, em: conf.em, bc: 200, b2: _List_Nil};
};
...
var pascallemerrer$elm_advanced_grid$Grid$viewColumn = F2(
	function (config, item) {
		return A2(config.as, config.b, item);
	});
			...
			case 2:
				return _Utils_Tuple2(
					elm$core$List$reverse(
						A2(elm$core$List$sortWith, columnConfig.J, model.cD)),
					2);
			case 1:
				return _Utils_Tuple2(
					A2(elm$core$List$sortWith, columnConfig.J, model.cD),
...
var pascallemerrer$elm_advanced_grid$Grid$withColumnsX = function (model) {
	return _Utils_update(
		model,
		{
			aD: pascallemerrer$elm_advanced_grid$Grid$columnsX(model)
		});
};
		...
		return pascallemerrer$elm_advanced_grid$Grid$withColumnsX(
			A2(
				...
				_Utils_update(
					config,
					{
						dS: pascallemerrer$elm_advanced_grid$Grid$sanitizedColumns(columns)
					}),
				model));
	});
var pascallemerrer$elm_advanced_grid$Grid$resizeColumn = F2(
	function (model, x) {
		...
		if (!_n0.$) {
			...
			var deltaX = x - model.aF;
			var newWidth = columnConfig.b.x + elm$core$Basics$round(deltaX);
			var newColumns = (_Utils_cmp(newWidth, pascallemerrer$elm_advanced_grid$Grid$minColumnWidth) > 0) ? A3(pascallemerrer$elm_advanced_grid$Grid$updateColumnWidthProperty, model, columnConfig, newWidth) : model.h.dS;
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 13:
				...
				var draggedColumn = {a3: columnConfig, aF: mousePosition.z, bN: '', z: mousePosition.z};
				return A2(
			...
			case 10:
				var columnConfig = msg.a;
				return model.a5 ? model : A4(pascallemerrer$elm_advanced_grid$Grid$sort, model, columnConfig, model.aq, pascallemerrer$elm_advanced_grid$Grid$toggleOrder);
			case 12:
				var item = msg.a;
				return _Utils_update(
					model,
			...
			case 18:
				return _Utils_update(
					model,
					{K: elm$core$Maybe$Nothing, ag: elm$core$Maybe$Nothing});
			case 14:
				return model;
			case 19:
				var position = msg.a;
				return A2(pascallemerrer$elm_advanced_grid$Grid$resizeColumn, model, position.z);
			case 20:
				var columnConfig = msg.a;
				...
				if (!_n3.$) {
					...
					if (_Utils_eq(columnConfig.b.m, draggedColumn.bN)) {
						...
						var newColumns = A3(pascallemerrer$elm_advanced_grid$Grid$moveColumn, columnConfig, draggedColumnConfig, model.h.dS);
						return A2(
							pascallemerrer$elm_advanced_grid$Grid$withDraggedColumn,
							elm$core$Maybe$Just(
								_Utils_update(
			...
			case 22:
				...
				return _Utils_update(
					updatedModel,
					{
						aD: pascallemerrer$elm_advanced_grid$Grid$columnsX(updatedModel)
					});
			default:
				var item = msg.a;
				var newContent = A3(
			...
			case 8:
				...
				return _Utils_Tuple2(
					...
					FabienHenon$elm_infinite_list_view$InfiniteList$scrollToNthItem(
						{
							dT: pascallemerrer$elm_advanced_grid$Grid$gridConfig(model),
							el: targetItemIndex,
							en: filteredContent,
...
var pascallemerrer$elm_advanced_grid$Examples$LargeList$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var _n1 = A2(pascallemerrer$elm_advanced_grid$Grid$update, pascallemerrer$elm_advanced_grid$Grid$ShowPreferences, model.k);
				...
				switch (msg.a.$) {
					...
					case 23:
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{k: newGridModel, aS: selectedItems}),
							A2(elm$core$Platform$Cmd$map, pascallemerrer$elm_advanced_grid$Examples$LargeList$GridMsg, gridCmd));
					case 21:
						var _n4 = msg.a;
						var _n5 = A2(pascallemerrer$elm_advanced_grid$Grid$update, pascallemerrer$elm_advanced_grid$Grid$UserToggledAllItemSelection, model.k);
						var newGridModel = _n5.a;
						var gridCmd = _n5.b;
						var selectedItems = newGridModel.ei ? newGridModel.cD : _List_Nil;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{k: newGridModel, aS: selectedItems}),
					...
					default:
						var message = msg.a;
						var _n6 = A2(pascallemerrer$elm_advanced_grid$Grid$update, message, model.k);
			...
			case 2:
				...
				var _n7 = A2(pascallemerrer$elm_advanced_grid$Grid$update, message, model.k);
			...
			case 3:
				...
				var _n8 = A2(pascallemerrer$elm_advanced_grid$Grid$update, message, model.k);
			...
			case 4:
				...
				var _n9 = A2(pascallemerrer$elm_advanced_grid$Grid$update, message, model.k);
			...
			case 5:
				...
				var _n10 = A2(pascallemerrer$elm_advanced_grid$Grid$update, message, model.k);
				...
				var message = pascallemerrer$elm_advanced_grid$Grid$ScrollTo(
					function (item) {
						return A2(
							...
							elm$core$String$toLower(item.b6.bA));
					});
				var _n11 = A2(pascallemerrer$elm_advanced_grid$Grid$update, message, model.k);
...
var mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$defaultOptions = {ch: true, cj: false};
...
var mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {dN: button, cB: clientPos, ep: keys, eD: offsetPos, eI: pagePos, eS: screenPos};
	});
...
var mpizenberg$elm_pointer_events$Internal$Decode$Keys = F3(
	function (alt, ctrl, shift) {
		return {dI: alt, dY: ctrl, aT: shift};
	});
...
var rtfeldman$elm_css$Css$row = {ca: 0, a6: 0, V: 'row'};
	...
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
				...
				rtfeldman$elm_css$Css$boxSizing(rtfeldman$elm_css$Css$contentBox),
				rtfeldman$elm_css$Css$height(
				rtfeldman$elm_css$Css$px(model.h.eb - pascallemerrer$elm_advanced_grid$Grid$cumulatedBorderWidth)),
...
var pascallemerrer$elm_advanced_grid$Grid$toPosition = function (event) {
	return {z: event.cB.a, bx: event.cB.b};
};
...
var rtfeldman$elm_css$Css$move = {c: 0, V: 'move'};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(elm$core$Maybe$withDefault, '', columnConfig.G))
				]),
			_List_Nil);
	});
...
var pascallemerrer$elm_advanced_grid$Grid$viewVerticalBar = A2(
	...
	_List_Nil);
var rtfeldman$elm_css$Css$colResize = {c: 0, V: 'col-resize'};
...
var rtfeldman$elm_css$Css$transparent = {O: 0, V: 'transparent'};
...
var pascallemerrer$elm_advanced_grid$Grid$viewSortingSymbol = F2(
	function (model, columnConfig) {
		...
		if (!_n0.$) {
			var config = _n0.a;
			return _Utils_eq(config.b.m, columnConfig.b.m) ? ((model.aq === 2) ? pascallemerrer$elm_advanced_grid$Grid$arrowUp : pascallemerrer$elm_advanced_grid$Grid$arrowDown) : pascallemerrer$elm_advanced_grid$Grid$noContent;
		} else {
...
var rtfeldman$elm_css$Css$italic = {aI: 0, V: 'italic'};
var rtfeldman$elm_css$Css$normal = {b9: 0, aI: 0, aa: 0, cg: 0, V: 'normal', aj: 0};
...
var rtfeldman$elm_css$Css$absolute = {bf: 0, V: 'absolute'};
var rtfeldman$elm_css$Css$left = rtfeldman$elm_css$Css$prop1('left');
var rtfeldman$elm_css$Css$none = {az: 0, cv: 0, D: 0, c: 0, n: 0, ed: 0, cX: 0, cb: 0, aO: 0, an: 0, S: 0, e: 0, d: 0, ce: 0, bX: 0, eK: 0, M: 0, bZ: 0, eT: 0, aV: 0, av: 0, I: 0, j: 0, e1: 0, V: 'none'};
...
var pascallemerrer$elm_advanced_grid$Grid$viewGhostHeader = function (model) {
	...
	if (!_n0.$) {
		...
		return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								rtfeldman$elm_css$Css$px(draggedColumn.z - model.bK.z)),
			...
			_List_fromArray(
				[
					A3(pascallemerrer$elm_advanced_grid$Grid$viewDataHeader, model, draggedColumn.a3, _List_Nil)
				]));
	} else {
		return pascallemerrer$elm_advanced_grid$Grid$noContent;
	}
	...
	function (model, currentColumn) {
		...
		if (!_n0.$) {
			...
			return _Utils_ap(
				...
				A2(pascallemerrer$elm_advanced_grid$Grid$isColumn, currentColumn, draggedColumn.a3) ? _List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[
					...
					[
						...
						mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onEnter(
							function (_n1) {
								return A2(pascallemerrer$elm_advanced_grid$Grid$UserSwappedColumns, currentColumn, draggedColumn.a3);
							}))
					]));
		} else {
			return _List_Nil;
...
var pascallemerrer$elm_advanced_grid$Grid$viewHeader = F3(
	function (model, columnConfig, index) {
		...
		var conditionalAttributes = _Utils_eq(model.ag, elm$core$Maybe$Nothing) ? _List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$Events$onClick(
		...
		[
			...
			_List_fromArray(
				[
					...
					rtfeldman$elm_css$Css$displayFlex,
					rtfeldman$elm_css$Css$height(
					rtfeldman$elm_css$Css$px(model.h.eb))
				])),
...
var FabienHenon$elm_infinite_list_view$InfiniteList$lazyView = F3(
	function (configValue, _n0, items) {
		...
		var skipCount = _n1.b1;
		var elements = _n1.bG;
		var topMargin = _n1.ah;
		var totalHeight = _n1.bm;
...
var rtfeldman$elm_css$Css$auto = {dH: 0, c: 0, aH: 0, bM: 0, eo: 0, aM: 0, ab: 0, S: 0, aP: 0, M: 0, b3: 0, aX: 0, I: 0, V: 'auto'};
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Css$height(
								rtfeldman$elm_css$Css$px(model.h.dV)),
								rtfeldman$elm_css$Css$width(
								rtfeldman$elm_css$Css$px(
									pascallemerrer$elm_advanced_grid$Grid$totalWidth(model))),
...
var rtfeldman$elm_css$Css$relative = {bf: 0, V: 'relative'};
...
var pascallemerrer$elm_advanced_grid$Grid$viewGrid = function (model) {
	var conditionalAttributes = ((!_Utils_eq(model.ag, elm$core$Maybe$Nothing)) || (!_Utils_eq(model.K, elm$core$Maybe$Nothing))) ? _List_fromArray(
		[
	...
	var attributes = _List_fromArray(
		[
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$width(
					rtfeldman$elm_css$Css$px(model.h.dW + pascallemerrer$elm_advanced_grid$Grid$cumulatedBorderWidth)),
			...
			[
				...
				_List_fromArray(
					[
						...
						rtfeldman$elm_css$Html$Styled$Attributes$type_('checkbox'),
						rtfeldman$elm_css$Html$Styled$Attributes$checked(columnConfig.b.ax),
						rtfeldman$elm_css$Html$Styled$Events$onClick(
			...
			[
				...
				_List_fromArray(
					[
						...
						rtfeldman$elm_css$Css$px(5)),
						rtfeldman$elm_css$Css$width(
						rtfeldman$elm_css$Css$px(model.h.dW * 0.6))
					]))
			]),
		A2(
			elm$core$List$cons,
...
var pascallemerrer$elm_advanced_grid$Examples$LargeList$viewItem = function (item) {
	return elm$html$Html$text(
		'id:' + (elm$core$String$fromInt(item.b6.m) + (' - name: ' + (item.b6.bQ + ''))));
};
...
var pascallemerrer$elm_advanced_grid$Examples$LargeList$viewSelectedItems = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$text(
				(!elm$core$List$isEmpty(model.aS)) ? 'SelectedItems:' : 'Use checkboxes to select items.'),
				A2(
				elm$html$Html$ul,
...
var pascallemerrer$elm_advanced_grid$Examples$LargeList$main = elm$browser$Browser$element(
	{
		eg: pascallemerrer$elm_advanced_grid$Examples$LargeList$init,
		eV: function (_n0) {
			return elm$core$Platform$Sub$none;
		},
		e0: pascallemerrer$elm_advanced_grid$Examples$LargeList$update,
