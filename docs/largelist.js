	...
	fa: function (item) {
		return _List_fromArray(
			[
				...
				$Orange_OpenSource$elm_advanced_grid$Examples$LargeList$rowClass(item)),
	...
	return A2(
		...
		A2(
			...
			function (columnConfig) {
				return $elm$core$String$fromInt(columnConfig.b.z) + 'px';
			},
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$width(
							$rtfeldman$elm_css$Css$px(state.ar)),
							$rtfeldman$elm_css$Css$height(
