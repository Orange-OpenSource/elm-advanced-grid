...
customGhostStyles : Internal.Common.Utils.Position -> Model -> List (Html.Attribute msg)
customGhostStyles offset (Model model) =
    case model of
        Nothing ->
            []
        ...
        Just state ->
            case state.dragElement of
                Just { element } ->
                    ...
                    , Html.Attributes.style "transform" <|
                        Internal.Common.Utils.translate
                            (round (state.currentPosition.x - state.startPosition.x + element.x + offset.x))
                            (round (element.y + offset.y))
                    , Html.Attributes.style "height" (Internal.Common.Utils.px (round element.height))
                    , Html.Attributes.style "width" (Internal.Common.Utils.px (round element.width))
                    , Html.Attributes.style "pointer-events" "none"
                    ]
